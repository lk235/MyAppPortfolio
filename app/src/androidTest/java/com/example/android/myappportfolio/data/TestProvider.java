...
//         */
    public void testGetType() {
        // content://com.example.android.myappportfolio/Movie/
        String type = mContext.getContentResolver().getType(MovieContract.MovieEntry.CONTENT_URI);
        // vnd.android.cursor.dir/com.example.android.myappportfolio/Movie
        assertEquals("Error: the MovieEntry CONTENT_URI should return MovieEntry.CONTENT_TYPE",
                MovieContract.MovieEntry.CONTENT_TYPE, type);

        String testCategroy = "popular";
        // content://com.example.android.myappportfolio/Movie/popular
        type = mContext.getContentResolver().getType(
                MovieContract.MovieEntry.buildMovieByCategory(testCategroy));
        // vnd.android.cursor.dir/com.example.android.myappportfolio/Movie
        assertEquals("Error: the MovieEntry CONTENT_URI by categroy should return MovieEntry.CONTENT_TYPE",
                MovieContract.MovieEntry.CONTENT_TYPE, type);
...
//     */
    public void testUpdateLocation() {
        ...
        updatedValues.put(MovieContract.MovieEntry.COLUMN_TITLE, "update Movie");
...
//            MovieValues.put(MovieContract.MovieEntry.COLUMN_HUMIDITY, 1.2 + 0.01 * (float) i);
//            MovieValues.put(MovieContract.MovieEntry.COLUMN_PRESSURE, 1.3 - 0.01 * (float) i);
//            MovieValues.put(MovieContract.MovieEntry.COLUMN_MAX_TEMP, 75 + i);
//            MovieValues.put(MovieContract.MovieEntry.COLUMN_MIN_TEMP, 65 - i);
//            MovieValues.put(MovieContract.MovieEntry.COLUMN_SHORT_DESC, "Asteroids");
//            MovieValues.put(MovieContract.MovieEntry.COLUMN_WIND_SPEED, 5.5 + 0.2 * (float) i);
